...
#RUN sleep 1000000
# build RMQ_API_PORT=9904;DB_PORT=9901;DB_USERNAME=dbuser;DB_PASSWORD=dbpassword;DB_NAME=goodcare;RMQ_USERNAME=rmqUser;RMQ_PASSWORD=rmqPwd
###################################################################################################
...
ENV name=goodcare_scheduler-0.0.1-SNAPSHOT
